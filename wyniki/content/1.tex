...
\begin{center}
  ...
  \noindent\circled[width=4pt]{78.7}{90}

  \[
    \textcolor{green!30!black}{\blacksquare} \text{Zagłosowało} = 78.7\% \quad \textcolor{gray!30}{\blacksquare} \text{Nie zagłosowało} = 10\% \quad \textcolor{red!40!black}{\blacksquare} \text{Nie przekazało danych} = 11.3\%
  \]
\end{center}
